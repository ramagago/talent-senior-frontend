...
const ServiceCard = ({ imgSource, title, description }) => {
  return (
    <div className="m-4 flex flex-col justify-center items-center bg-white w-60 mobile:w-72 h-96 py-10 px-10 text-center rounded-3xl transition ease-in-out hover:scale-105 hover:cursor-pointer">
